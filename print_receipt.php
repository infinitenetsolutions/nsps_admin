                                ...
                                <div class="row">
                                   <div class="col-12" id="error_section"></div>
                                    <div class="col-4">
                                        ...
                                        <input type="text" name="studentRegistrationNo" class="form-control rounded-pill">
                                    </div>

                                    <div class="col-2" style="margin-top: 29px;">
                                        <button type="submit" id="fetchStudentDataButton" class="btn btn-primary btn-block rounded-pill">Go <i class="fas fa-angle-double-right" aria-hidden="true"></i> </button>
                                    </div>
                                </div>
                            </div>
                        </form>
