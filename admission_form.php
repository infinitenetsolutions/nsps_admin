              ...
              <div class="card-body">
                <div class="row">
                 ...
                 <div class="col-4">
                  ...
                  <div class="col-4">
                    <label>Birth Certificate<i class="fa fa-file" aria-hidden="true"></i> </label>
                    <input type="file" name="bc" class="form-control" value="">
                  </div>
                  <div class="col-4">
                    <label>Profile photo <i class="fa fa-user" aria-hidden="true"></i> </label>
                    <input type="file" name="tc" class="form-control" value="">
                  </div>
                  <div class="col-4">
