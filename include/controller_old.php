       ...
       if($_POST["action"] == "add_semester"){
        ...
        //    exit();
            if($success)
            {
                ...
                $sql_course = "SELECT * FROM `tbl_branch` WHERE id NOT IN ()";
                $result_course = $con->query($sql_course);
                // while($row_course = $result_course->fetch_assoc()){
                
                           echo '<div class="modal fade" id="registration" tabindex="1" role="dialog" aria-labelledby="myModalLabel">
                                    ...
                                    <table class="table table-bordered" id="dynamic_field" style="overflow-y:auto;">  
                                             <thead>
                                                <tr>
                                                     ...
                                                     <th data-field="fee_name" data-sortable="true" rowspan="2">Particulars</th>
                                             ...
                                             <tbody>
                                                 <tr> 
                                                     ...
                                                     <td width="12%"><input type="number" name="fine[]" placeholder="Fine" class="form-control"/></td>
                                                     <td width="22%">
