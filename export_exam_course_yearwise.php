<?php
    ...
    if(isset($_POST["action"]) && $_POST["action"] == "export_examfees_details"){
        ...
        //Set Filename
        $fileName = "Course-And-Year-Exam-Wise-Fee-Report-".date('d-m-Y').".xlsx";
        //Set BackGround
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('B2', "Course And Year Wise Fee Report");
//         cellColor('B2', 'FFC107');
        cellColor('B2', 'DC3545');
