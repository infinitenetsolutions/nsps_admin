...
if (isset($_POST['course_id']) && $_POST['course_id'] != '' && isset($_POST['student_name']) && $_POST['student_name'] != '') {
    ...
    if (isset($_FILES['bc']['tmp_name']) && $_FILES['bc']['tmp_name'] != '') {
        $tc_img = addslashes(file_get_contents($_FILES['bc']['tmp_name']));
        $_POST['bc'] = $tc_img;
    }
...
$student_data = fetchRow('tbl_student', $cond);
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mrt">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="section_id" id="sem" required>
                                                ...
                                                if ($branch != '') {
                                                ?>
                                                    <option value="<?= $branch['section_id'] ?>"><?= $branch['section_name'] ?></option>
                                                <?php } else { ?>
                                                    <option selected disabled> Select Class </option>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="col-4">
                                      ...
                                      <div class="col-4">
                                        <div class="row">
                                            <div class="col-5">
                                                <label>Birth Certificate <i class="fa fa-file" aria-hidden="true"></i></i></label>
                                                <input type="file" name="bc" class="form-control">
                                            </div>
                                            <div class="col-7">
                                                <?= '<img class="img-fluid" src="data:image/jpeg;base64,' . base64_encode($student_data['bc']) . '"/>'  ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="row">
                                            <div class="col-5">
                                                <label>Transfer Certificate <i class="fa fa-user" aria-hidden="true"></i> </label>
                                    ...
                                    <div class="col-4">
                                        <div class="row">
                                            <div class="col-5">
                                                <label>Profile photo <i class="fa fa-file" aria-hidden="true"></i></i></label>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <input type="text" name="parent_contactno" value="<?= $student_data['parent_contactno'] ?>" class="form-control">
                                            </div>
                                            <div class="col-4">
