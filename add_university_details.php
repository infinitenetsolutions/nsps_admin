...
<head>
    ...
    <title>Netaji Subhas Public School | School Details </title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Netaji Subhas Public School Details</h1>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Netaji Subhas Public School</h3>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Full name of school " name="add_university_details_university_name" class="form-control" required>
                                                </div>

                                                <div class="form-group">
                                                    <label>Affiliation Details</label>
                                                    <input type="text" placeholder="Affiliation Details" name="add_university_details_affiliation_details" class="form-control" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Address</label>
                                                    <input type="text" placeholder="Address" name="add_university_details_address" class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Email</label>
                                                    <input type="text" placeholder="Email address of School" name="add_university_details_email" class="form-control" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Contact number" name="add_university_details_contact" class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Logo</label>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Website url" name="add_university_details_website_url" class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                </div>
                                            </div>
    ...
    <script>
        $(document).ready(function (e){
            ...
            $('#add_university_details_form').on('submit', (function(e) {
                ...
                $('#add_university_details_button').prop('disabled', true);
                var file_data = $('#add_university_details_logo_image').prop('files')[0];
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        console.log(result);
                        $('#response').remove();
                        $('#add_university_details_form')[0].reset();
                        $('#error_section').append('<div id = "response">' + result + '</div>');
                        $('#loading').fadeOut(500, function() {
                            $(this).remove();
                        });
                        $('#add_university_details_button').prop('disabled', false);
                    }
